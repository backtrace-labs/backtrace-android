...
public class ThrowableTypeAdapterFactory2 implements TypeAdapterFactory {

    public static JsonArray parseStacktraceElements(StackTraceElement[] stackTraceElements) throws JSONException {
    ...
    public static JsonArray addStacktraceElements(JsonWriter out, StackTraceElement[] stackTraceElements) throws JSONException, IOException {
        JsonArray stackTraceArray = new JsonArray();
