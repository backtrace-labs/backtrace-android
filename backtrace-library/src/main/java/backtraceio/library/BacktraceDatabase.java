...
public class BacktraceDatabase implements Database {
    ...
    private void setupTimer() {
        ...
        _timer.scheduleAtFixedRate(
                    ...
                    public void run() {
                        ...
                        while (record != null) {
                            ...
                            if (backtraceData == null || backtraceData.getReport() == null) {
                                BacktraceLogger.d(
                                        LOG_TAG, "Timer - backtrace data or report is null - " + "deleting record");
                                delete(record);
                            } else {
                                ...
                                BacktraceApi.send(backtraceData, new OnServerResponseEventListener() {
                                    ...
                                    public void onEvent(BacktraceResult backtraceResult) {
                                        if (backtraceResult.status == BacktraceResultStatus.Ok) {
                                            ...
                                            currentRecord.close();
                                            // backtraceDatabaseContext.incrementBatchRetry(); TODO: consider another
                                            // way to remove some records after few retries
                                        }
                ...
                databaseSettings.getRetryInterval() * 1000,
                databaseSettings.getRetryInterval() * 1000);
    }
