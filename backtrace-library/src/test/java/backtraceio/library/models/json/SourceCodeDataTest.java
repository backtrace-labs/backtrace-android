...
public class SourceCodeDataTest {
    ...
    public void deserialize() {
        ...
        assertEquals(
                "VMStack.java",
                obj.data.get("8751bea6-d6f6-48f4-9f96-1355c3408a9a").getSourceCodeFileName());
        assertNull(obj.data.get("8751bea6-d6f6-48f4-9f96-1355c3408a9a").getStartLine());
        assertEquals(
                "InvokeMethod.java",
                obj.data.get("27948842-7c2b-4898-a74a-ba3ca4afe814").getSourceCodeFileName());
        assertEquals(
                17,
                obj.data
                        .get("27948842-7c2b-4898-a74a-ba3ca4afe814")
                        .getStartLine()
                        .intValue());
    }
    ...
    public void serializeAndDeserialize() {
        ...
        assertEquals(
                "VMStack.java",
                result.data.get("8751bea6-d6f6-48f4-9f96-1355c3408a9a").getSourceCodeFileName());
        assertNull(result.data.get("8751bea6-d6f6-48f4-9f96-1355c3408a9a").getStartLine());
        assertEquals(
                "InvokeMethod.java",
                result.data.get("27948842-7c2b-4898-a74a-ba3ca4afe814").getSourceCodeFileName());
        assertEquals(
                17,
                result.data
                        .get("27948842-7c2b-4898-a74a-ba3ca4afe814")
