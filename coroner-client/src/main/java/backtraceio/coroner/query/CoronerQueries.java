...
public class CoronerQueries {
    ...
    public JsonObject filterByErrorTypeAndTimestamp(final String errorType, final String timestampLeast, final String timestampMost, final List<String> attributes) {
        final CoronerFiltersBuilder filtersBuilder = new CoronerFiltersBuilder();
