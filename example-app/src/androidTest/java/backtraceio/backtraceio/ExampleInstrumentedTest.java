...
public class ExampleInstrumentedTest extends InstrumentedTest {
    ...
    public void enableMetricsAndBreadcrumbs() {
        ...
        // Android 15+ specific: Ensure network operations are allowed
        if (android.os.Build.VERSION.SDK_INT >= 34) { // Android 15 is API 34
            System.out.println("Android 15+ detected - applying network security workarounds");
        }
    ...
    public void handledException() throws TimeoutException, CoronerResponseProcessingException, InterruptedException {
        ...
        System.out.println("Device: " + android.os.Build.MODEL);
        ...
        waiter.await(20, TimeUnit.SECONDS, 1); // Increased timeout for Android 16 compatibility
    ...
    //
    // //@Test
    // public void unhandledException() throws CoronerResponseProcessingException,
    // InterruptedException {
    // // GIVEN
    // CoronerResponse response = null;
    // long timestampStart = this.getSecondsTimestampNowGMT();
